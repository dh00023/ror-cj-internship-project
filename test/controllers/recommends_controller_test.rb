...
class RecommendsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create recommend" do
    assert_difference('Recommend.count') do
      post recommends_url, params: { recommend: { banner_id: @recommend.banner_id, code: @recommend.code } }
    end
  ...
  test "should update recommend" do
    patch recommend_url(@recommend), params: { recommend: { banner_id: @recommend.banner_id, code: @recommend.code } }
